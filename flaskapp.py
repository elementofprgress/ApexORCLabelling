...
def new_verification():
    ...
    try:
        con = sql.connect('C:/apexocr/images_database.db')
    except sql.Error as error:
        # f1 = open("temp_log.txt", "a")
        # f1.write("error connecting to sql db: " + str(error) +"\n")
        # f1.close()
...
def update():
    ...
    if request.method == 'POST':
        try:
            ...
            # f1 = open("temp_log.txt", "a")
            # f1.write(_filename_base + " X: " + _pos_x + " Y: " + _pos_y + " Z: " + _pos_y + " " + _pos_x_verified + " " + _pos_y_verified + " " + _pos_z_verified +" test \n")
            # f1.close()
            ...
            if _pos_x == _pos_x_verified and _pos_z == _pos_z_verified and _pos_z == _pos_z_verified:
                ...
                try:
                    ...
                    msg = "sql error when entering values to verified database"
                    print("ERROR: "+e)
                con.commit()
